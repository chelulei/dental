        ...
        <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="register_students.php"><i class="fa fa-user" aria-hidden="true"></i> Students</a>
                        <a class="dropdown-item" href="register_staff.php"> <i class="fa fa-user-circle-o" aria-hidden="true"></i> Staff</a>
                        <div class="dropdown-divider"></div>
                    </div>
                </li>
                <li class="nav-item dropdown">
