...
if (isset($_POST['save'])) {
 ...
 $sql = "INSERT INTO staff (staff_no,last_name,first_name,middle_name,department,gender, bday,age,contact_no,date) 
VALUES ('$staff_no','$last_name','$first_name','$middle_name','$department','$gender', '$bday','$age','$contact_no', NOW())";
